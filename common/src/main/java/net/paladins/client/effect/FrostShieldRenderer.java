...
public class FrostShieldRenderer implements CustomModelStatusEffect.Renderer {
    public static final Identifier modelId_base = new Identifier(PaladinsMod.ID, "effect/frost_shield_base");
    public static final Identifier modelId_overlay = new Identifier(PaladinsMod.ID, "effect/frost_shield_overlay");
