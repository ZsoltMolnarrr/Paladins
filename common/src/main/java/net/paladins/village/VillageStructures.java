...
/// injector stays null and the monk sanctuaries are only placed through the data-driven paths that ship
/// in `resources/data/paladins` (Repurposed Structures pool additions, Lithostitched worldgen modifiers).
