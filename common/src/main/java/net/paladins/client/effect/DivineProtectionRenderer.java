...
public class DivineProtectionRenderer extends OrbitingEffectRenderer {
    public static final Identifier modelId_base = new Identifier(PaladinsMod.ID, "spell_effect/divine_protection");
    public static final Identifier modelId_overlay = new Identifier(PaladinsMod.ID, "spell_effect/divine_protection_glow");
